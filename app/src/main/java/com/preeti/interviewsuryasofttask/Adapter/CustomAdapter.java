package com.preeti.interviewsuryasofttask.Adapter;
...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public CustomAdapter(Context context,List<UserInformation> dataList){
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.lname.setText(dataList.get(position).lastName);
        holder.Email.setText(dataList.get(position).emailId);
